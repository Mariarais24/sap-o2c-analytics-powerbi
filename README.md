# 📦 SAP Sales & Order Analytics - Unilever Pakistan
...
A regional bar chart compares ordered vs billed volume across cities; Lahore leads with 1,316 MT ordered but only 909 MT billed. 

The weekly trend chart shows a peak in W11 (1,087 MT) followed by a steady decline toward W9. 

The order fulfillment funnel breaks down where volume is getting stuck: 46K billed, 12K rejected, 10K pending, with minimal confirmed-not-delivered and delivered-not-billed volume. 

Billed volume by division shows Home Care dominating at 43% (1,315 MT), with Surf, Knorr, and Lifebuoy leading by brand.
...
Diagnoses where and why orders fail. Rejection rate sits at **17.35%** (11,958 rejected orders), with an average delivery lead time of 1.4 days and a rescheduling rate of 89.56%. Lahore accounts for 4,974 rejected orders, the highest absolute rejection volume followed by Karachi at 2,816. 

Lead time by region shows Faisalabad, Lahore, and Gujranwala at 2 days vs 1 day for most other cities flagging potential supply chain pressure. 

Fulfillment rate by brand reveals Comfort (94.4%) and Hellmann's (92.8%) at the top, while Paddle Pop/Max (71.8%) and Lux (72.3%) lag significantly behind. 

Weekly rejection rate peaked at 35% in W13, declining to 11% by W11.
